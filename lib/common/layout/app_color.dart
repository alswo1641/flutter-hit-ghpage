...
class AppColor {
  ...
  static const Color expertColor = Color(0xff1C24ED);

  static const Color teamColor = Color(0xff149940);

  static const Color projectColor = Color(0xffff0000);

  static const Color lightGreyButtonColor = Color(0xfff2f2f2);
  static const Color lightBlueButtonColor = Color(0xff1986E0);
  static const Color plainButtonColor = Color(0xff363636);

  static const Color lightYellow = Color(0xFDFFFFDE);

  static const Color black = Color(0xFF000000);
  static const Color black13 = Color(0xFF131313);
  static const Color black14 = Color(0xFF141519);
  static const Color black17 = Color(0xFF171715);
  static const Color black1A = Color(0xFF1A1C21);
  static const Color black1C = Color(0xFF1C1C20);
  static const Color black1E = Color(0xFF1E1E1C);
  static const Color black29 = Color(0xFF292929);

  static const Color darkGrey = Color(0xFF625E5C);

  // static const Color logoColor = Color(0xFF0077FF);
  static const Color appColor = Color(0xff1524FE);
  static const Color blueAccent = Color(0xff1D24F1);
  static const Color tableHeaderColor = Color(0xfff2f2f2);
  static const Color darkBlue = Color(0xff2b3f6c);

  // static const Color darkGrey = Color(0xff16141A);
  static const Color boldGrey = Color(0xff2D2E3C);
  ...
  static const Color disableTextColor = Color(0xff4E4F52);
  ...
  static const Color purpleBlack = Color(0xff1E1C28);
  static const Color dialogGrey = Color(0xff2F2F36);
  static const Color greyBlack = Color(0xff3C3C40);
  static const Color blueGrey = Color(0xff555D6A);
  ...
  static const Color backGrey = Color(0xff444448);
  ...
  static const Color skyBlue = Color(0XFF1B86DD);
}
